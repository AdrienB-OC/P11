def test_comp_places_update(client):
    ...
    response_4 = client.get('/book/Fall Classic/Simply Lift')

    assert response_4.status_code == 200
    assert b'Booking for Fall Classic' in response_4.data
    assert b'Places available: 10' in response_4.data
